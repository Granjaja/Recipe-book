  ...
  return (
   <div>
    ...
    <div className=" flex justify-center gap-3 p-5">
      <Button className="bg-sky-500"> <Link href="/createrecipe" >Create recipes</Link> </Button>
      <Button className="bg-sky-500"><Link href="/recipes">Learn new cooking tricks</Link></Button>
    </div>
